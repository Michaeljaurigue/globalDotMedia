...
function DigitalMarketingPackages() {
  return (
    <>
      <HeroHeader
        h1={"Digital Marketing Packages"}
        h2={"Global.Media is a full-service digital marketing agency."}
        p={
          "Get help with your digital marketing strategy, SEO, social media, content marketing, email marketing, and more."
        }
        link={"/images/digital-marketing-packages.jpg"}
      />
      <LandingPage
